...
function Navbar() {
  return (
    ...
    <h1 className="hover:text-orange-400" ><Link href='/'>photo</Link></h1>
    <h1 className="hover:text-orange-400"> <Link className="hover:text-orange-400" href='/'>blog</Link></h1>
    <h1 className="hover:text-orange-400"> <Link className="hover:text-orange-400" href='/'>me</Link></h1>
    </div>
    </div>
