  ...
  return (
    <>
      ...
      <ProseLayout socials={socials}>
        <article className='col-span-8 max-w-7xl mx-auto min-h-fit '>
          ...
          <p className="text-center text-p3 md:text-p2 font-jost font-semibold"><span className="text-gray-900 border-b-4 border-blue-400">{postDate.toLocaleDateString('en-GB')}</span></p>
