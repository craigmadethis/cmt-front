...
export const SidebarLayout = (props) => {
  return (
    <div className='bg-gray-50  flex flex-col h-full min-h-screen justify-between'>
      <Navbar />
      <main className="w-full px-4 mb-auto md:px-0 md:w-5/6 mx-auto grid grid-cols-8 md:grid-cols-12 mt-6  justify-between ">
        {props.children}
  ...
  return (
    <div className='bg-gray-50 min-h-screen flex flex-col min-h-screen justify-between'>
      ...
      <div className="w-full px-2 md:px-0 md:w-5/6 mx-auto grid grid-cols-8 md:grid-cols-12 mt-6 mb-auto ">
        <main className="col-span-12 grid grid-cols-8 border-b-2 border-gray-200">
          {props.children}
        </main>
      </div>
      <Footer socials={props.socials} />
...
export const GalleryLayout = (props) => {
  ...
  return (
    <div className='bg-gray-50 min-h-screen flex flex-col min-h-screen justify-between'>
      ...
      <main className="w-full px-4 md:px-0 mx-auto grid grid-cols-8 md:grid-cols-12 my-6 mb-auto border-b-2 border-gray-400">
                ...
                <a href=''>
                  <LightgalleryItem src={url} group="page" subHtml={caption} className='aspect-square p-2' >
                    ...
                    <div className='h-[40vh] aspect-square m-1 hover:opacity-75 relative'>
                      <Image className="" src={`${url}`} alt={`${alt}`} layout="fill" sizes="80vw" objectFit='cover' placeholder='blur' blurDataURL={blurLoader(url)} />
                    </div>
                  </LightgalleryItem>
                </a>
              </Link>
