...
<Link href='/blog/post/[slug]' as={`/blog/post/${postSlug}`} key={postSlug}>
    ...
    <div key={postSlug}>
      ...
      <div className='relative w-full aspect-square mt-2 place-self-center m-6 '>
    ...
    <div>
      <div className='w-full font-bitter text-p3 md:text-p2 pt-2 md:pt-4 h-32'>
    ...
    <Link href='/blog/post/[slug]' as={`/blog/post/${postSlug}`}><a><p className='w-full pt-2 font-jost font-semibold  text-p2 md:text-p1 text-right hover:text-blue-400 justify-end'>Read more {'>'}</p></a></Link>
