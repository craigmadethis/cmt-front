  ...
  return (
    ...
    {allImages.map(({attributes: {url, caption, alternativeText: alt}}) => 
            <div className='mx-auto w-full my-4 aspect-[4/3] relative break-inside-avoid '>
              <LightgalleryItem src={`http://localhost:1337${url}`} group="page" subHtml={caption}>
      <a>
                  <Image className="img-responsive" src={`http://localhost:1337${url}`} alt={alt} layout='fill' objectFit='contain'  quality='50' />
      </a>
