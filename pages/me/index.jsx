...
const Me = ({ socials, me }) => {
  ...
  return (
    ...
    <ProseLayout socials={socials}>
      <section className='markdown col-span-8 min-h-fit'>
        ...
        <div className='flex flex-col md:flex-row w-full'>
          ...
          <figure className='w-full md:w-1/3 h-96 max-h-fit md:max-h-fit relative my-12'>
            <Image src={me.attributes.avatar.data.attributes.url} layout='fill' objectFit='contain' sizes='30vw' alt='Me' />
          </figure>
        </div>
